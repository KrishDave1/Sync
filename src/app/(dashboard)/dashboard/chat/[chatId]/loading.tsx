...
//!IMP LESSON LEARNT - Most of the times the skeleton is going to be used in the places where you are rendering/displaying some javascript data.Other stylings remain exactly the same.So copy the actual page and wherever the variables are ther replace them with Skeleton components.
